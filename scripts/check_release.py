...
ROOT_FILES = {
    'desktop_entry.py', 'installer.iss', 'build-requirements.txt',
    ...
    'requirements.txt', 'README.md', 'README.en.md', 'private_storage.py', 'LICENSE', 'THIRD_PARTY_NOTICES.md',
...
def release_files():
    ...
    for directory, suffix in (('docs', '.md'), ('tests', '.py'), ('scripts', '.py'), ('sounds', '.wav'), ('sounds', '.mp3')):
